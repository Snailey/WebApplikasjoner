...
try {
  ...
  /// functions default parameters ///
	...
	(function UseDefaultParameters() {
		...
		function hello(who) {
			...
			return 'Hello ' + (who = (who == null) ?'World':who )+ '!';
  ...
  /// Rest parameter ///
	...
	(function UseRestParameter() {
		...
		function foo(a, b, ...manyMoreArgs) {
			return a + b + manyMoreArgs.length;
		}
  ...
  /// Spread operator ///
	...
	(function UseSpreadOperator2() {
		...
		let result = arr1.concat(value, arr2);
...
line 2`;
  ...
  /// Destructuring (bonus) ///
	...
	(function UseObjectDestructuring2() {
		...
		var { a, b, c } = { a: obj.name, b: obj.age, c: obj.add };
	...
	(function UseNestedDestructuring() {
		...
		var { a, b, c } = { a: obj.add, b: obj.city.name, c: obj.arr.slice(1) };
